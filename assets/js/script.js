...
const cargarVideos = (() => {
  ...
  const musicaProbar = new Reproductor('https://www.youtube.com/embed/XcZCeAx6cYQ', 'musica');
  const videoProbar = new Reproductor('https://www.youtube.com/embed/-PRggytyXUg', 'peliculas');
  const serieProbar = new Reproductor('https://www.youtube.com/embed/EshjSGSg0q0', 'series');
